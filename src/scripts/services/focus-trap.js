...
export default class FocusTrap {
  ...
  /**
   * Deactivate.
   * @returns {HTMLElement|undefined} Element that had focus before trap was activated.
   */
  deactivate() {
    if (!this.isActivated) {
      return;
    ...
    return this.elementThatHadFocus;
  }
  ...
  handleVisible() {
    ...
    if (this.currentFocusElement) {
      this.elementThatHadFocus = document.activeElement;
    }
