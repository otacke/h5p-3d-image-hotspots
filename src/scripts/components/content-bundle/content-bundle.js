...
export default class ContentBundle {
  ...
  constructor(params = {}) {
    ...
    this.dom.classList.add('h5p-3d-image-hotspots-content-bundle');
  ...
  addContent(contentParams) {
    ...
    instanceWrapper.classList.add('h5p-3d-image-hotspots-content-wrapper');
    ...
    // The usual workaround for HFP-4289 :-(
